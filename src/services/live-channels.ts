...
export const OPTIONAL_LIVE_CHANNELS: BuiltinLiveChannel[] = [
  ...
  { id: 'newsmax', name: 'Newsmax', handle: '@NewsmaxTV' },
  ...
  { id: 'skai-tv', name: 'SKAI TV', handle: '@skaigr' },
