...
Facts reconciled: 2026-09-20 — see Data Coverage below for how each figure is derived.
...
Coverage reconciled: 2026-09-20. Every figure below is generated from this repository's authoritative registries by `npm run build:ai-search` — the same registries that produce https://www.worldmonitor.app/sources/.

- 748 active data providers across 762 observed source hosts (333 structured/API, 461 news & OSINT feed, 30 operational-status; a host can be more than one), grouped into 10 signal domains — full catalog at https://www.worldmonitor.app/sources/
