...
export const INSIGHTS_SYNTHESIS_FAILURE_CODES = Object.freeze({
  ...
  LEAD_STATUS_QUALIFIER: 'INSIGHTS_SYNTHESIS_LEAD_STATUS_QUALIFIER',
...
const INSIGHTS_GATE_REASON_CODES = new Map([
  ...
  [BRIEF_REJECTIONS.LEAD_STATUS_QUALIFIER, INSIGHTS_SYNTHESIS_FAILURE_CODES.LEAD_STATUS_QUALIFIER],
