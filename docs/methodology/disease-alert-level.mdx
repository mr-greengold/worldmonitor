...
The "[Disease Outbreaks](/panels/disease-outbreaks)" panel tags each item **ALERT**, **WARNING**, or
...
- CDC HAN, ECDC epidemiological update, and CIDRAP disease news RSS (`rssNormalizeItem`)
