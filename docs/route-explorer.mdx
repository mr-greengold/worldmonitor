...
Alternative maritime corridors if the primary lane is degraded — for example, [Cape of Good Hope](https://www.worldmonitor.app/chokepoints/cape-of-good-hope/) as a detour around the Suez + Bab-el-Mandeb system. Each alternative shows added transit days and an added-cost multiplier, filtered to corridors that are actually suitable for the selected cargo type.
