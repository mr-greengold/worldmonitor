...
**Theater posture integration** — when the [Strategic Posture Assessment](/panels/strategic-posture) detects elevated military activity (e.g., unusual flight patterns in a theater), related news stories receive additional scoring boosts, surfacing contextually relevant reporting alongside the military signal.
