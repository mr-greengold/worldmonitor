...
description: "Active disease-outbreak alerts worldwide, severity-ranked and searchable — aggregated from WHO DON, CDC HAN, ECDC, CIDRAP, and ProMED."
---
...
- **ECDC epidemiological updates** — the European Centre for Disease Prevention and Control's outbreak updates, including events outside the EU/EEA.
- **CIDRAP disease news** — University of Minnesota CIDRAP feeds for Ebola, viral hemorrhagic fever, avian influenza, mpox, cholera, measles, dengue, polio, and foodborne disease. A story counts only when it names a known disease and a country and is under 90 days old; multi-story "Quick takes" roundups are skipped.
