...
Depending on where you live (including under the EU/UK GDPR and the California CCPA/CPRA), you may have the right to access, correct, export, or delete your personal data, and to object to or restrict certain processing. Signed-in users can delete their World Monitor account from **Avatar → Plan & billing → Delete account** by typing `DELETE`; see [Accounts](/accounts). If you cannot sign in, write from the account email to [support@worldmonitor.app](mailto:support@worldmonitor.app) so we can confirm the Clerk user id. Anonymous dashboard use has no server account — clear local site data instead. To exercise any of these rights, contact us at [support@worldmonitor.app](mailto:support@worldmonitor.app). You also have the right to complain to your local data protection authority.
