...
Each item carries the complete [decision-signal provenance](/decision-signal-provenance) envelope: publisher
...
publication is not treated as independent corroboration. The [activity nowcast](/methodology/china-activity-nowcast)
