...
| [`/llms-full.txt`](https://worldmonitor.app/llms-full.txt) | (extension) | Full LLM corpus: product brief plus inlined glossary, chokepoint methodology and explainers, Country Resilience Index methodology, corrections log, and the published ranking snapshot |
